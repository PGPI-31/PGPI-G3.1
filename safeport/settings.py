...
STRIPE_PUBLISHABLE_KEY = config('STRIPE_SECRET_KEY', '')
STRIPE_CURRENCY = "eur"
STRIPE_WEBHOOK_SECRET = os.getenv('STRIPE_WEBHOOK_SECRET', 'whsec_3e874fb27d6df25ff738339987cb7ce0a97bc9876475d0e7e7735d339840f76f')